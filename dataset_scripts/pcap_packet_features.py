    ...
    with open(dst_file_name, "a") as csv_file:
        for packet in pcap:
            ...
            for key in attributes:
                if 'flag_' in key and not split_flags:
                    continue
                entry[key] = ''
            ...
            try:
                ...
                # If attribute is not available, assign a default value
                entry['tcp_flag_ns'] = None  # or any other default value you prefer
                # You can add similar handling for other missing attributes if needed
